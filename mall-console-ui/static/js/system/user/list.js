                ...
                if (resultList.length > 0) {
                    $.each(resultList, function (index, item) {
                        ...
                        if (0 == item.type || 1 == item.type) {
                            html += '<td class="td-status"><span class="label label-danger radius">系统管理账户</span></td>';
                        } else if (2 == item.type) {
                            html += '<td class="td-status"><span class="label label-success radius">公司管理账户</span></td>';
                        } else {
                            html += '<td class="td-status"><span class="label label-warning radius">公司员工账户</span></td>';
                        }
                        if (0 == item.gender) {
                            html += '<td class="td-status"><span class="label label-danger radius">保密</span></td>';
                        } else if (1 == item.gender) {
                            html += '<td class="td-status"><span class="label label-success radius">男</span></td>';
                        } else {
                            html += '<td class="td-status"><span class="label label-warning radius">女</span></td>';
                        }
                    ...
                    laypage.render({
                        ...
                        jump: function (obj, first) {
                            ...
                            if (!first) {
                                ...
                                this.reloadPageResultList(obj.curr, obj.limit);
                            }
                        }
                    });
                }
