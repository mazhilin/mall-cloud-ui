...
!function (t) {
    ...
    function e(t) {
        return {
            set: function (e, i) {
                t.setItem(e, o.serialize(i))
            }, get: function (e) {
                return o.deserialize(t.getItem(e))
            }, remove: function (e) {
                t.removeItem(e)
            }, clear: function () {
                t.clear()
    ...
    var i = t.document, n = {};
    $(t).on("load", function () {
        "function" == typeof FastClick && FastClick.attach(i.body)
    });
    var o = n.util = {
        parseOptions: function (t) {
            ...
            return {
                lock: function () {
                    e || (e = !0, i.addEventListener("touchmove", t))
                }, unlock: function () {
                    e = !1, i.removeEventListener("touchmove", t)
                }
            }
        }(), localStorage: function () {
            return e(t.localStorage)
        }(), sessionStorage: function () {
            return e(t.sessionStorage)
    ...
    function i(t) {
        ...
        return this.each(function () {
            var n = $(this), o = n.data("ydui.actionsheet");
            o || (n.data("ydui.actionsheet", o = new e(this, t.closeElement)), t && "object" != typeof t || o.open()), "string" == typeof t && o[t] && o[t].apply(o, i)
        })
    }

    var n = t.document, o = $(n), a = $(n.body), r = $('<div class="mask-black"></div>');
    e.prototype.open = function () {
        YDUI.device.isIOS && $(".g-scrollview").addClass("g-fix-ios-overflow-scrolling-bug");
        var t = this;
        a.append(r), r.on("click.ydui.actionsheet.mask", function () {
            t.close()
        }), t.closeElement && o.on("click.ydui.actionsheet", t.closeElement, function () {
            t.close()
        }), t.$element.addClass(t.toggleClass).trigger("open.ydui.actionsheet")
    }, e.prototype.close = function () {
        var t = this;
        YDUI.device.isIOS && $(".g-scrollview").removeClass("g-fix-ios-overflow-scrolling-bug"), r.off("click.ydui.actionsheet.mask").remove(), t.$element.removeClass(t.toggleClass).trigger("close.ydui.actionsheet")
    }, o.on("click.ydui.actionsheet.data-api", "[data-ydui-actionsheet]", function (e) {
        e.preventDefault();
        var n = t.YDUI.util.parseOptions($(this).data("ydui-actionsheet")), o = $(n.target),
            a = o.data("ydui.actionsheet") ? "open" : n;
        i.call(o, a)
    }), $.fn.actionSheet = i
}(window), !function (t) {
    t.document.addEventListener("touchstart", function (t) {
    }, !1)
}(window), !function (t) {
    "use strict";
    ...
    function i(t) {
        var i = Array.prototype.slice.call(arguments, 1);
        return this.each(function () {
            var n = $(this), o = n.data("ydui.cityselect");
    ...
    e.DEFAULTS = {provance: "", city: "", area: ""}, e.prototype.init = function () {
        ...
        var t = this;
        n.append(t.$mask), YDUI.device.isMozilla && t.$element.blur(), t.$mask.on("click.ydui.cityselect.mask", function () {
            t.close()
        });
        var e = t.$cityElement, i = t.defaultSet;
    ...
    }, e.prototype.bindItemEvent = function () {
        ...
        e.on("click.ydui.cityselect", ".cityselect-item-box a", function () {
            ...
            if (!i.hasClass("crt")) {
                ...
                var o = e.find(".cityselect-nav a"), a = t.defaultSet;
        ...
        var e = this, i = e.$itemBox.eq(t), n = i.find("a.crt").height(), o = i.parent().height();
        i.parent().animate({scrollTop: i.find("a.crt").index() * n - o / 3}, 0, function () {
            e.bindItemEvent()
        })
        ...
        var t = this, e = t.$itemBox.eq(0).find("a.crt").data("citys"), i = [];
        $.each(e, function (e, n) {
        ...
        var t = this, e = t.$itemBox.eq(1).find("a.crt").data("citys"), i = [];
        $.each(e, function (e, n) {
            i.push($('<a class="' + (n == t.defaultSet.area ? "crt" : "") + '" href="javascript:;"><span>' + n + "</span></a>").data({tag: 2}))
        }), i.length <= 0 && i.push($('<a href="javascript:;"><span>全区</span></a>').data({tag: 2})), t.fillItems(2, i)
    }, $.fn.citySelect = i
}(window), !function (t) {
    var e = t.document, i = t.YDUI, n = t.navigator && t.navigator.userAgent || "",
        o = !!n.match(/(iPad).*OS\s([\d_]+)/), a = !!n.match(/(iPod)(.*OS\s([\d_]+))?/),
    ...
    "use strict";
    var i = e.dialog = e.dialog || {}, n = $(t.document.body);
    i.confirm = function (t, i, o) {
        ...
        2 == r && (o = i, i = t, t = "提示");
        var s = o;
        "function" == typeof o && (s = [{txt: "取消", color: !1}, {
            txt: "确定", color: !0, callback: function () {
                o && o()
            }
        }]);
        ...
        $.each(s, function (t, i) {
            var n;
            "boolean" == typeof i.color ? n = $('<a href="javascript:;" class="confirm-btn ' + (i.color ? "primary" : "default") + '">' + (i.txt || "") + "</a>") : "string" == typeof i.color && (n = $('<a href="javascript:;" style="color: ' + i.color + '">' + (i.txt || "") + "</a>")), function (t) {
    ...
    e.DEFAULTS = {
        ...
        var e = this, i = e.options, o = t.location;
        ...
        var t = this, e = t.options, i = $(e.binder), o = n.sessionStorage.get(t.backParamsKey);
        o && i.stop().animate({scrollTop: o.offsetTop}, 0, function () {
            t.scrolling = !1
        }), e.backposition && t.bindLinkEvent(), n.pageScroll.unlock(), n.sessionStorage.remove(t.backParamsKey)
    }, e.prototype.bindScrollEvent = function () {
        var e = this, i = $(e.options.binder), n = i.get(0) === t, o = n ? $(t).height() : i.height();
        ...
        return e.jumpLink ? void $(t.options.binder).on("click.ydui.infinitescroll", t.options.jumpLink, function (e) {
            e.preventDefault();
            var i = $(this), o = i.data("page");
            return o ? (n.sessionStorage.set(t.backParamsKey, {
                offsetTop: $(t.options.binder).scrollTop() + i.offset().top - t.listOffsetTop,
                page: o
            }), void (location.href = i.attr("href"))) : void console.error('[YDUI warn]: 跳转链接元素需添加属性[data-page="其所在页码"]')
        }) : void console.error("[YDUI warn]: 需指定跳转详情页链接元素")
    }, e.prototype.loadList = function () {
        var t = this, e = t.options;
        t.loading = !0, t.$loading.show(), "function" == typeof e.loadListFn && e.loadListFn().done(function (i, o) {
            var a = i.length;
            return ~~a <= 0 ? void console.error("[YDUI warn]: 需在 resolve() 方法里回传本次获取记录集合") : (a < e.pageSize && (t.$element.append('<div class="list-donetip">' + e.doneTxt + "</div>"), t.isDone = !0), t.$loading.hide(), t.loading = !1, void (e.backposition && n.sessionStorage.set(t.backParamsListKey + o, i)))
        })
    }, e.prototype.loadListFromStorage = function () {
        var t = this, e = n.sessionStorage.get(t.backParamsKey);
        if (e) {
            n.pageScroll.lock();
            for (var i = e.page, o = [], a = 1; a <= i; a++) {
                ...
                o.push({
                    page: a,
                    list: r
                }), a == i && r.length < t.options.pageSize && (t.$element.append('<div class="list-donetip">' + t.options.doneTxt + "</div>"), t.$loading.hide(), t.loading = !1, t.isDone = !0)
            }
            t.options.loadStorageListFn(o, i + 1).done(function () {
                t.scrollPosition()
            })
        }
    }, $.fn.infiniteScroll = i
    ...
    function i(t) {
        var i = Array.prototype.slice.call(arguments, 1);
        return this.each(function () {
            var n = $(this), o = n.data("ydui.keyboard");
            o || n.data("ydui.keyboard", o = new e(this, t)), "string" == typeof t && o[t] && o[t].apply(o, i)
        })
    }

    var n = $(t.document.body),
        o = !!(t.navigator && t.navigator.userAgent || "").match(/AppleWebKit.*Mobile.*/) || "ontouchstart" in t.document.documentElement,
        a = o ? "touchstart" : "click";
    e.DEFAULTS = {disorder: !1, title: "安全键盘"}, e.prototype.init = function () {
        ...
        var t = this, e = t.$element, i = t.$numsBox;
        YDUI.device.isIOS && $(".g-scrollview").addClass("g-fix-ios-overflow-scrolling-bug"), e.addClass(t.toggleClass), (t.options.disorder || 1 != i.data("loaded-nums")) && i.data("loaded-nums", 1).html(t.createNumsHtml()), n.append(t.$mask), t.bindEvent()
    }, e.prototype.close = function () {
        var t = this;
        ...
        t.$mask.on(a + ".ydui.keyboard.mask", function (e) {
            e.preventDefault(), t.close()
        }), e.on(a + ".ydui.keyboard.nums", ".J_Nums", function (e) {
            t.inputNums.length >= 6 || (t.inputNums = t.inputNums + $(this).html(), t.clearError(), t.fillPassword())
        }), e.on(a + ".ydui.keyboard.backspace", ".J_Backspace", function (e) {
            e.preventDefault(), t.backspace()
        }), e.on(a + ".ydui.keyboard.cancel", ".J_Cancel", function (e) {
            e.preventDefault(), t.close()
        })
    }, e.prototype.unbindEvent = function () {
        this.$element.off(a + ".ydui.keyboard"), $(t).off("hashchange.ydui.keyboard")
    }, e.prototype.fillPassword = function () {
        var t = this, e = t.inputNums, i = e.length, n = t.$element.find(".J_FillPwdBox").find("li");
        ...
        var t = this, e = t.options.disorder;
    ...
    }, e.prototype.upsetOrder = function (t) {
        for (var e, i, n, o = Math.floor, a = Math.random, r = t.length, s = o(r / 2) + 1; s--;) e = o(a() * r), i = o(a() * r), e !== i && (n = t[e], t[e] = t[i], t[i] = n);
        return t
    }, $.fn.keyBoard = i
}(window), !function (t) {
    "use strict";
    ...
    e.DEFAULTS = {
        ...
        var e = this, i = e.options, n = $(i.binder), o = n.height(),
            a = n.get(0) === t ? $(t).scrollTop() : n.offset().top;
        e.$element.each(function () {
            var t = $(this), e = t.offset().top - a, i = e + t.height();
    ...
    function e(t, e) {
        this.pathTemplate = "M 50,50 m 0,-{radius} a {radius},{radius} 0 1 1 0,{2radius} a {radius},{radius} 0 1 1 0,-{2radius}", n.apply(this, arguments)
    }

    function i(t, e) {
        this.pathTemplate = "M 0,{center} L 100,{center}", n.apply(this, arguments)
    }

    function n(t, e) {
        this.$element = $(t), this.options = $.extend({}, n.DEFAULTS, e || {})
    }

    function o(t) {
        var n = Array.prototype.slice.call(arguments, 1);
        return this.each(function () {
            var o = $(this), a = o.data("ydui.progressbar");
    ...
    var a = t.document, r = t.YDUI.util;
    e.prototype = new n, e.prototype.getPathString = function (t) {
        var e = this, i = 50 - t / 2;
        return e.render(e.pathTemplate, {radius: i, "2radius": 2 * i})
    }, e.prototype.initSvg = function (t) {
        t.setAttribute("viewBox", "0 0 100 100"), t.style.display = "block", t.style.width = "100%"
    }, i.prototype = new n, i.prototype.getPathString = function (t) {
        var e = this;
        return e.render(e.pathTemplate, {center: t / 2})
    }, i.prototype.initSvg = function (t, e) {
        ...
        var i = this, n = i.$binder, o = n.height(), a = n.get(0) === t ? $(t).scrollTop() : n.offset().top,
            r = e.offset().top - a, s = r + e.height();
        (r >= 0 && r < o || s > 0 && s <= o) && e.trigger("appear.ydui.progressbar")
    }, n.prototype.createSvgView = function () {
        var t = this, e = t.options, i = a.createElementNS("http://www.w3.org/2000/svg", "svg");
        t.initSvg(i, e);
        var n = t.createPath(e);
        i.appendChild(n);
        var o = null;
        return (e.trailColor || e.trailWidth) && (o = t.createTrailPath(e), o.style.strokeDashoffset = o.getTotalLength(), i.appendChild(o)), t.svg = i, t.trailPath = o, {
            svg: i,
            trailPath: o
        }
    ...
    }, n.prototype.createPathElement = function (t, e, i, n) {
        var o = a.createElementNS("http://www.w3.org/2000/svg", "path");
        return o.setAttribute("d", t), o.setAttribute("stroke", e), o.setAttribute("stroke-width", i), n ? o.setAttribute("fill", n) : o.setAttribute("fill-opacity", "0"), o
    }, n.prototype.render = function (t, e) {
        var i = t;
        for (var n in e) if (e.hasOwnProperty(n)) {
            var o = e[n], a = "\\{" + n + "\\}", r = new RegExp(a, "g");
            i = i.replace(r, o)
        }
        return i
    ...
    e.DEFAULTS = {loadListFn: null, initLoad: !0, distance: 100}, e.prototype.init = function () {
        ...
        var e = this, i = t.originalEvent.touches[0];
        ...
        e.loading = !0, "function" == typeof t.options.loadListFn && t.options.loadListFn().done(function () {
            setTimeout(function () {
                t.$dragTip.css({transform: "translate3d(0px, " + t.options.distance / 1.5 + "px, 0px) scale(0)"}), t.resetDragTip()
            }, 200)
        })
        ...
        this.$dragTip.css({transform: "translate3d(0," + t + "px,0) scale(1)"})
    }, e.prototype.initTip = function () {
        var e = this, i = t.localStorage;
    ...
    function i(t) {
        var i = Array.prototype.slice.call(arguments, 1);
        return this.each(function () {
            var n = this, o = $(n), a = o.data("ydui.scrolltab");
    ...
    e.DEFAULTS = {
        ...
        if (!i.scrolling) {
            ...
            if (n[0]) {
                var o = n.offset().top, a = o + i.$content.scrollTop() - i.contentOffsetTop + 1;
                i.$content.stop().animate({scrollTop: a}, e ? 200 : 0, function () {
                    i.scrolling = !1
                })
            }
        }
    ...
    function e(e) {
        var i = Array.prototype.slice.call(arguments, 1);
        return this.each(function () {
            var n = $(this), o = n.data("ydui.sendcode");
    ...
    t.DEFAULTS = {
        ...
        var t = this, e = t.options, i = e.secs;
    ...
    function i(t) {
        return this.each(function () {
            var i = $(this), n = i.data("ydui.slider");
    ...
    e.DEFAULTS = {
        ...
        var t = this, e = t.$wrapper, i = t.$wrapper.find("." + t.options.slideClass),
            n = i.filter(":first-child").clone(), o = i.filter(":last-child").clone();
        ...
        var e = this, i = e.$wrapper.find("." + e.options.slideClass).eq(t).find("img"), n = i.data("src");
        ...
        var t = this, e = t.options.speed, i = t.$wrapper.width(), n = t.touches, o = n.moveOffset;
    ...
    function i(t) {
        var i = Array.prototype.slice.call(arguments, 1);
        return this.each(function () {
            var n = $(this), o = n.data("ydui.spinner");
    ...
    e.DEFAULTS = {
        ...
        var t = this, e = t.options, i = [{param: "unit", "default": 1}, {param: "max", "default": 0}];
        $.each(i, function (i, n) {
            var o = e[n.param], a = t.$input.data(n.param);
            if (a) o = a, t.isNumber(a) || (o = e[n.param], "function" == typeof o && (o = o())); else if ("function" == typeof e[n.param]) {
                var r = e[n.param]();
        ...
        var t = this, e = t.options, i = t.$input.val();
        ...
        var e = this, i = e.options, n = i.max, o = i.unit, a = i.min, r = e.$input, s = e.FixNumber(r.val());
        ...
        var e = this, i = (new Date).getTime() / 1e3, n = i - e.tapStartTime;
        n < 1 && (n = .5);
        var o = 10 * n;
        ...
        var e = this, i = e.options, n = i.max, o = i.unit, a = i.min < 0 ? o : i.min;
        ...
        var t = this, e = t.options, i = YDUI.device.isMobile, n = "mousedown.ydui.spinner", o = "mouseup.ydui.spinner";
    ...
    function i(t) {
        var i = Array.prototype.slice.call(arguments, 1);
        return this.each(function () {
            var n = this, o = $(n), a = o.data("ydui.tab");
    ...
    e.TRANSITION_DURATION = 150, e.DEFAULTS = {
        ...
        var i = e.$nav.eq(t);
        e.transitioning || i.hasClass(e.options.activeClass) || (e.transitioning = !0, i.trigger($.Event("open.ydui.tab", {index: t})), e.active(i, e.$nav), e.active(e.$panel.eq(t), e.$panel, function () {
            i.trigger({type: "opened.ydui.tab", index: t}), e.transitioning = !1
        }))
        ...
        var a = this, r = a.options.activeClass, s = i.filter("." + r);
    ...
    "use strict";
    var util = window.YDUI.util = window.YDUI.util || {}, doc = window.document;
    util.timestampTotime = function (t, e) {
        ...
        var o = this, a = setInterval(function () {
        ...
        var e = new RegExp("(^|&)" + t + "=([^&]*)(&|$)"), i = window.location.search.substr(1).match(e), n = "";
        ...
        return {
            get: function (t) {
                ...
                var r = String(encodeURIComponent(e)), s = i;
