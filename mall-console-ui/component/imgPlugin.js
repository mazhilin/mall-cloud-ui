            ...
            $(this).change(function() {
                ...
                if (fileList.length > imageNum|| totalNum > imageNum) {
                    ...
                    for ( var i = 0; i < fileList.length; i++) {
                        ...
                        $img0.attr("src","/fansi/manager/img/a7.png").appendTo($section);
            ...
            function uploadImg(opt, file, obj) {
                ...
                $.ajax({
                    ...
                    success : function(data) {
                        ...
                        // 上传成功
                        //此处判断改为代表我json结构体的成功判断
                        if (data.code == "200") {
                            $(".up-section").removeClass("loading");
                            $(".up-img").removeClass(
                                "up-opcity");
                            $("#imguploadFinish").val(true);
                            var htmlStr = "<input type='text' class='banner'style='display:none;' name='"
                                + opt.formData.name
                                + "' value='"
                                + data.result.url
                                + "'>";
