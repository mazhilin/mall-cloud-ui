...
(function (factory) {
	...
	$.extend(Plugin.prototype, {
		...
		_construct: function(){
			...
			this.$input = $('<input type="text"' + (isMobile? 'tabindex="-1"': '') + ' placeholder="'+p+'" class="'+ this.settings.inputClass + '" oninput="changeClassDetail(this)" onpropertychange="changeClassDetail(this)">').appendTo(this.$container)
