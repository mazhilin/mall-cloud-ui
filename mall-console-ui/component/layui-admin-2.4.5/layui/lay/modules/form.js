            ...
            select: function () {
                var e, i = "请选择", a = "layui-form-select", n = "layui-select-title", r = "layui-select-none", d = "",
                    f = u.find("select"), v = function (i, l) {
                        ...
                        var pageBox = $(i.target).parent().parent().attr('class') || '';
                        var aBox = $(i.target).parent().attr('class') || '';
                        var btn = $(i.target).attr('class')
                        if ((pageBox.indexOf('layui-laypage') > -1 || aBox.indexOf('layui-laypage') > -1)) {
                            return false;
                        }
